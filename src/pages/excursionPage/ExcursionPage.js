        ...
        <>
            <div className="excursion">
                <div className="container">
                    ...
                    <div className="excursion__descr">Эрмитаж — это то место, которое стоит посетить в Петербурге. Конечно же, за один день нереально увидеть весь Эрмитаж. Со мной вы прогуляетесь по залам музея, познакомитесь с историей Зимнего дворца и увидите шедевры мастеров прошлого из Западной Европы.</div>
